...
export default function Cart() {
  ...
  return <>
    <article className="bg-white round-2xl shadow-2xl p-8 absolute right-8 top-32 left-8 lg:w-96 lg:left-auto lg:top-20"
    style={{
      zIndex: 1000,
      width: "300px",
    }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <ul>
          <li className="text-slate-600 text-small">{`${text.substring(0, 23)}...`}</li>
